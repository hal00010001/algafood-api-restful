 ...
 * 
 * @Override public List<Cidade> listar() { return
 * manager.createQuery("from Cidade", Cidade.class).getResultList(); }
 * 
 * @Override public Cidade buscar(Long id) { return manager.find(Cidade.class,
 * id); }
 * 
 * @Override
 * 
 * @Transactional public Cidade salvar(Cidade cidade) { return
 * manager.merge(cidade); }
 * 
 * @Override
 * 
 * @Transactional public void remover(Long id) { Cidade cidade = buscar(id); if
 * (cidade == null) { throw new EmptyResultDataAccessException(1); }
